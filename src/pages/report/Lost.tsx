...
import { Search, MapPin, Calendar, AlertTriangle, Camera } from 'lucide-react';
...
const lostItemSchema = z.object({
  ...
  location: z.string().min(1, 'Please enter the location where you lost the item'),
  specific_location: z.string().optional(),
  date_lost_found: z.string().min(1, 'Please select the date when you lost the item'),
...
const Lost = () => {
  ...
  const onSubmit = async (data: LostItemForm) => {
    try {
      const itemData = {
        ...
        reward_offered: data.reward_offered && data.reward_offered.trim() !== '' ? parseFloat(data.reward_offered) : null,
      };
      ...
      toast({
        ...
        description: "Your lost item has been submitted. We'll notify you if someone finds it!",
      });
  ...
  return (
    <div className="min-h-screen sunset-gradient">
      <Header />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 fade-in">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Lost something important? Report it here and let our community help you find it.
            </p>
          </div>
          ...
          <Card className="elegant-card bg-white/95 backdrop-blur-md border-0 shadow-2xl slide-up">
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-3xl font-bold text-primary">Lost Item Details</CardTitle>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <textarea
                            placeholder="Describe your item in detail - color, brand, model, distinctive features, any personal marks..."
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="e.g., near the entrance, study room 205, parking lot B"
                              className="h-12 text-lg rounded-2xl border-gray-300 focus:border-primary"
                              {...field}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-lg font-semibold text-primary">Time Lost (Optional)</FormLabel>
                          <FormControl>
                            <Input
                              type="time"
                              className="h-12 text-lg rounded-2xl border-gray-300 focus:border-primary"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-lg font-semibold text-primary">Reward Amount (Optional)</FormLabel>
                          <FormControl>
                            <Input
                              type="number"
                              placeholder="25.00"
                  ...
                  <div className="space-y-4">
                    <label className="text-lg font-semibold text-primary flex items-center gap-2">
                      ...
                      Upload Photos (Strongly Recommended - Max 5)
                    </label>
                      ...
                      <label htmlFor="image-upload" className="cursor-pointer">
                        {imagePreviews.length > 0 ? (
                          ...
                          <div className="text-gray-500">
                            ...
                            <p className="text-sm">Photos greatly improve the chances of finding your item</p>
                          </div>
                        )}
                      </label>
                    </div>
                  ...
                  <div className="flex justify-center pt-8">
                    <Button
                      ...
                      className="elegant-button button-lost px-12 py-4 text-xl font-semibold"
                    >
                      {createItemMutation.isPending ? 'Submitting...' : 'Submit Lost Item Report'}
                    </Button>
                  </div>
                </form>
              </Form>
