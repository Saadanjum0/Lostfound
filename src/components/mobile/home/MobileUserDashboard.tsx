...
// Enhanced ItemCard component with proper image display - EXACT SAME AS WEB
...
// Loading skeleton component - EXACT SAME AS WEB
    ...
    <div className="min-h-screen relative">
      ...
      <main className="relative z-20">
        <div className="max-w-7xl mx-auto space-y-8 px-4 py-8">
          {/* Enhanced Welcome Section - EXACT SAME AS WEB */}
          ...
          {/* Enhanced Statistics Grid - EXACT SAME AS WEB */}
          ...
          {/* Enhanced Quick Actions - EXACT SAME AS WEB */}
          ...
          {/* Enhanced Tabs Section - EXACT SAME AS WEB */}
          ...
          {/* Logout Confirmation Dialog - EXACT SAME AS WEB */}
